...
class __TwigTemplate_e79309192d200e59b4f0d1b0e0dcbdac7f7cd6951aea691d1b45803e09e41bc0 extends Template
{
    private $source;
    private $macros = [];
...
{% block beforePage %}
    ...
    <div class=\"shadow bg-white rounded max-w-4xl mx-auto pt-4 pb-6 px-8 mb-6\">
        ...
        <p style='padding-top: 7px'>
            {{ __('Created by Tinashe Matanda, EduCentral is the school platform which solves real problems faced by educators every day.') }}
            <br/><br/>
            {{ __('Free, open source and flexible, EduCentral can morph to meet the needs of a huge range of schools.') }}
            <br/><br/>
...
{% endblock beforePage %}
", "installer/install.twig.html", "C:\\xampp\\htdocs\\gibbon\\resources\\templates\\installer\\install.twig.html");
    }
}
